...
setup(
    name="masonite-organisations",
    # Versions should comply with PEP440.  For a discussion on single-sourcing
    # the version across setup.py and the project code, see
    # https://packaging.python.org/en/latest/single_source_version.html
    version="0.0.1",
    package_dir={"": "src"},
    description="Organisations/Roles/Invitations management for Masonite",
    long_description="Organisations/Roles/Invitations management for Masonite",
    # The project's main homepage.
    url="https://github.com/girardinsamuel/masonite-organisations",
    # Author details
